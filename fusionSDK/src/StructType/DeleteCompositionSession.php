...
/**
 * This class stands for DeleteCompositionSession StructType
 * @subpackage Structs
 */
class DeleteCompositionSession extends AbstractStructBase
{
    /**
     * The request
    ...
    public $request;
    /**
     * Constructor method for DeleteCompositionSession
     * @uses DeleteCompositionSession::setRequest()
     ...
     * @param \StructType\CompositionFilePathURLRequest $request
     * @return \StructType\DeleteCompositionSession
     */
