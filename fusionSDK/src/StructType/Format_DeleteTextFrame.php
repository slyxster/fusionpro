...
/**
 * This class stands for Format_DeleteTextFrame StructType
 * @subpackage Structs
 */
class Format_DeleteTextFrame extends AbstractStructBase
{
    /**
     * The CompositionID
    ...
    public $name;
    /**
     * Constructor method for Format_DeleteTextFrame
     * @uses Format_DeleteTextFrame::setCompositionID()
     * @uses Format_DeleteTextFrame::setName()
     ...
     * @param int $compositionID
     * @return \StructType\Format_DeleteTextFrame
     */
