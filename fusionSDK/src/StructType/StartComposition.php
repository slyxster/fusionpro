...
/**
 * This class stands for StartComposition StructType
 * @subpackage Structs
 */
class StartComposition extends AbstractStructBase
{
    /**
     * The Request
    ...
    public $Request;
    /**
     * Constructor method for StartComposition
     * @uses StartComposition::setRequest()
     ...
     * @param \StructType\CompositionRequest $request
     * @return \StructType\StartComposition
     */
