...
/**
 * This class stands for GetWebConfigureSettings StructType
 * @subpackage Structs
 */
class GetWebConfigureSettings extends AbstractStructBase
{
    /**
     * The req
    ...
    public $req;
    /**
     * Constructor method for GetWebConfigureSettings
     * @uses GetWebConfigureSettings::setReq()
     ...
     * @param \StructType\TemplateRequest $req
     * @return \StructType\GetWebConfigureSettings
     */
