...
/**
 * This class stands for GetTemplateResourceFilePath StructType
 * @subpackage Structs
 */
class GetTemplateResourceFilePath extends AbstractStructBase
{
    /**
     * The req
    ...
    public $req;
    /**
     * Constructor method for GetTemplateResourceFilePath
     * @uses GetTemplateResourceFilePath::setReq()
     ...
     * @param \StructType\TemplateRequest $req
     * @return \StructType\GetTemplateResourceFilePath
     */
