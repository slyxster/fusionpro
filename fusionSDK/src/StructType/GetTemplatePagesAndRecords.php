...
/**
 * This class stands for GetTemplatePagesAndRecords StructType
 * @subpackage Structs
 */
class GetTemplatePagesAndRecords extends AbstractStructBase
{
    /**
     * The req
    ...
    public $req;
    /**
     * Constructor method for GetTemplatePagesAndRecords
     * @uses GetTemplatePagesAndRecords::setReq()
     ...
     * @param \StructType\TemplateRequest $req
     * @return \StructType\GetTemplatePagesAndRecords
     */
