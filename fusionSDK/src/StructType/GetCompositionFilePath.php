...
/**
 * This class stands for GetCompositionFilePath StructType
 * @subpackage Structs
 */
class GetCompositionFilePath extends AbstractStructBase
{
    /**
     * The request
    ...
    public $request;
    /**
     * Constructor method for GetCompositionFilePath
     * @uses GetCompositionFilePath::setRequest()
     ...
     * @param \StructType\CompositionFilePathURLRequest $request
     * @return \StructType\GetCompositionFilePath
     */
