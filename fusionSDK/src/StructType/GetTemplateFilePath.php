...
/**
 * This class stands for GetTemplateFilePath StructType
 * @subpackage Structs
 */
class GetTemplateFilePath extends AbstractStructBase
{
    /**
     * The req
    ...
    public $req;
    /**
     * Constructor method for GetTemplateFilePath
     * @uses GetTemplateFilePath::setReq()
     ...
     * @param \StructType\TemplateRequest $req
     * @return \StructType\GetTemplateFilePath
     */
