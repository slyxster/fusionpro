...
/**
 * This class stands for Format_GetGraphicFrameNamesOnPage StructType
 * @subpackage Structs
 */
class Format_GetGraphicFrameNamesOnPage extends AbstractStructBase
{
    /**
     * The CompositionID
    ...
    public $Page;
    /**
     * Constructor method for Format_GetGraphicFrameNamesOnPage
     * @uses Format_GetGraphicFrameNamesOnPage::setCompositionID()
     * @uses Format_GetGraphicFrameNamesOnPage::setPage()
     ...
     * @param int $compositionID
     * @return \StructType\Format_GetGraphicFrameNamesOnPage
     */
