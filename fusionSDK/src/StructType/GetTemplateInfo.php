...
/**
 * This class stands for GetTemplateInfo StructType
 * @subpackage Structs
 */
class GetTemplateInfo extends AbstractStructBase
{
    /**
     * The req
    ...
    public $req;
    /**
     * Constructor method for GetTemplateInfo
     * @uses GetTemplateInfo::setReq()
     ...
     * @param \StructType\TemplateRequest $req
     * @return \StructType\GetTemplateInfo
     */
