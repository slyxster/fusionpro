...
/**
 * This class stands for GetCompositionSessions StructType
 * @subpackage Structs
 */
class GetCompositionSessions extends AbstractStructBase
{
    /**
     * The request
    ...
    public $request;
    /**
     * Constructor method for GetCompositionSessions
     * @uses GetCompositionSessions::setRequest()
     ...
     * @param \StructType\CompositionSessionRequest $request
     * @return \StructType\GetCompositionSessions
     */
