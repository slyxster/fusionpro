...
/**
 * This class stands for CreateCompositionSession StructType
 * @subpackage Structs
 */
class CreateCompositionSession extends AbstractStructBase
{
    /**
     * The Request
    ...
    public $Request;
    /**
     * Constructor method for CreateCompositionSession
     * @uses CreateCompositionSession::setRequest()
     ...
     * @param \StructType\CompositionRequest $request
     * @return \StructType\CreateCompositionSession
     */
