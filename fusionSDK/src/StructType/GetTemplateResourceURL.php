...
/**
 * This class stands for GetTemplateResourceURL StructType
 * @subpackage Structs
 */
class GetTemplateResourceURL extends AbstractStructBase
{
    /**
     * The req
    ...
    public $req;
    /**
     * Constructor method for GetTemplateResourceURL
     * @uses GetTemplateResourceURL::setReq()
     ...
     * @param \StructType\TemplateRequest $req
     * @return \StructType\GetTemplateResourceURL
     */
