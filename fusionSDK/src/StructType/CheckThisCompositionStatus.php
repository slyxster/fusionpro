...
/**
 * This class stands for CheckThisCompositionStatus StructType
 * @subpackage Structs
 */
class CheckThisCompositionStatus extends AbstractStructBase
{
    /**
     * The request
    ...
    public $request;
    /**
     * Constructor method for CheckThisCompositionStatus
     * @uses CheckThisCompositionStatus::setRequest()
     ...
     * @param \StructType\CompositionFilePathURLRequest $request
     * @return \StructType\CheckThisCompositionStatus
     */
