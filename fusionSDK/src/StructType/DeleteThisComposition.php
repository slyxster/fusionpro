...
/**
 * This class stands for DeleteThisComposition StructType
 * @subpackage Structs
 */
class DeleteThisComposition extends AbstractStructBase
{
    /**
     * The request
    ...
    public $request;
    /**
     * Constructor method for DeleteThisComposition
     * @uses DeleteThisComposition::setRequest()
     ...
     * @param \StructType\CompositionFilePathURLRequest $request
     * @return \StructType\DeleteThisComposition
     */
