...
/**
 * This class stands for EndCompositionSession StructType
 * @subpackage Structs
 */
class EndCompositionSession extends AbstractStructBase
{
    /**
     * The request
    ...
    public $request;
    /**
     * Constructor method for EndCompositionSession
     * @uses EndCompositionSession::setRequest()
     ...
     * @param \StructType\CompositionFilePathURLRequest $request
     * @return \StructType\EndCompositionSession
     */
