...
/**
 * This class stands for GetCompositionFileBytes StructType
 * @subpackage Structs
 */
class GetCompositionFileBytes extends AbstractStructBase
{
    /**
     * The request
    ...
    public $request;
    /**
     * Constructor method for GetCompositionFileBytes
     * @uses GetCompositionFileBytes::setRequest()
     ...
     * @param \StructType\CompositionFilePathURLRequest $request
     * @return \StructType\GetCompositionFileBytes
     */
