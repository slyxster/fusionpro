...
/**
 * This class stands for GetCompositionInfo StructType
 * @subpackage Structs
 */
class GetCompositionInfo extends AbstractStructBase
{
    /**
     * The request
    ...
    public $request;
    /**
     * Constructor method for GetCompositionInfo
     * @uses GetCompositionInfo::setRequest()
     ...
     * @param \StructType\CompositionFilePathURLRequest $request
     * @return \StructType\GetCompositionInfo
     */
