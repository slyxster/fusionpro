...
/**
 * This class stands for GetCompositionResourceFilePath StructType
 * @subpackage Structs
 */
class GetCompositionResourceFilePath extends AbstractStructBase
{
    /**
     * The request
    ...
    public $request;
    /**
     * Constructor method for GetCompositionResourceFilePath
     * @uses GetCompositionResourceFilePath::setRequest()
     ...
     * @param \StructType\CompositionFilePathURLRequest $request
     * @return \StructType\GetCompositionResourceFilePath
     */
