...
/**
 * This class stands for GetTemplateJobOptions StructType
 * @subpackage Structs
 */
class GetTemplateJobOptions extends AbstractStructBase
{
    /**
     * The req
    ...
    public $req;
    /**
     * Constructor method for GetTemplateJobOptions
     * @uses GetTemplateJobOptions::setReq()
     ...
     * @param \StructType\TemplateRequest $req
     * @return \StructType\GetTemplateJobOptions
     */
