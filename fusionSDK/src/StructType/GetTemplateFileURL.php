...
/**
 * This class stands for GetTemplateFileURL StructType
 * @subpackage Structs
 */
class GetTemplateFileURL extends AbstractStructBase
{
    /**
     * The req
    ...
    public $req;
    /**
     * Constructor method for GetTemplateFileURL
     * @uses GetTemplateFileURL::setReq()
     ...
     * @param \StructType\TemplateRequest $req
     * @return \StructType\GetTemplateFileURL
     */
