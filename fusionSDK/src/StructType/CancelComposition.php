...
/**
 * This class stands for CancelComposition StructType
 * @subpackage Structs
 */
class CancelComposition extends AbstractStructBase
{
    /**
     * The request
    ...
    public $request;
    /**
     * Constructor method for CancelComposition
     * @uses CancelComposition::setRequest()
     ...
     * @param \StructType\CompositionFilePathURLRequest $request
     * @return \StructType\CancelComposition
     */
