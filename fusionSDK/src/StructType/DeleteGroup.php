...
/**
 * This class stands for DeleteGroup StructType
 * @subpackage Structs
 */
class DeleteGroup extends AbstractStructBase
{
    /**
     * The req
    ...
    public $req;
    /**
     * Constructor method for DeleteGroup
     * @uses DeleteGroup::setReq()
