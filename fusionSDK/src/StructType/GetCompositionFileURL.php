...
/**
 * This class stands for GetCompositionFileURL StructType
 * @subpackage Structs
 */
class GetCompositionFileURL extends AbstractStructBase
{
    /**
     * The request
    ...
    public $request;
    /**
     * Constructor method for GetCompositionFileURL
     * @uses GetCompositionFileURL::setRequest()
     ...
     * @param \StructType\CompositionFilePathURLRequest $request
     * @return \StructType\GetCompositionFileURL
     */
