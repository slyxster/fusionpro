...
/**
 * This class stands for SetWebConfigureSettings StructType
 * @subpackage Structs
 */
class SetWebConfigureSettings extends AbstractStructBase
{
    /**
     * The req
    ...
    public $req;
    /**
     * Constructor method for SetWebConfigureSettings
     * @uses SetWebConfigureSettings::setReq()
     ...
     * @param \StructType\TemplateRequest $req
     * @return \StructType\SetWebConfigureSettings
     */
