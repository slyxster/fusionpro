...
/**
 * This class stands for CancelThisComposition StructType
 * @subpackage Structs
 */
class CancelThisComposition extends AbstractStructBase
{
    /**
     * The request
    ...
    public $request;
    /**
     * Constructor method for CancelThisComposition
     * @uses CancelThisComposition::setRequest()
     ...
     * @param \StructType\CompositionFilePathURLRequest $request
     * @return \StructType\CancelThisComposition
     */
