...
/**
 * This class stands for GetTemplateFormData StructType
 * @subpackage Structs
 */
class GetTemplateFormData extends AbstractStructBase
{
    /**
     * The req
    ...
    public $req;
    /**
     * Constructor method for GetTemplateFormData
     * @uses GetTemplateFormData::setReq()
     ...
     * @param \StructType\TemplateRequest $req
     * @return \StructType\GetTemplateFormData
     */
