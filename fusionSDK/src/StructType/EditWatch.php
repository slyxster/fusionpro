...
/**
 * This class stands for EditWatch StructType
 * @subpackage Structs
 */
class EditWatch extends AbstractStructBase
{
    /**
     * The req
    ...
    public $req;
    /**
     * Constructor method for EditWatch
     * @uses EditWatch::setReq()
