...
/**
 * This class stands for GetCompositionResourceURL StructType
 * @subpackage Structs
 */
class GetCompositionResourceURL extends AbstractStructBase
{
    /**
     * The request
    ...
    public $request;
    /**
     * Constructor method for GetCompositionResourceURL
     * @uses GetCompositionResourceURL::setRequest()
     ...
     * @param \StructType\CompositionFilePathURLRequest $request
     * @return \StructType\GetCompositionResourceURL
     */
