...
/**
 * This class stands for AddCompositionResource StructType
 * @subpackage Structs
 */
class AddCompositionResource extends AbstractStructBase
{
    /**
     * The request
    ...
    public $request;
    /**
     * Constructor method for AddCompositionResource
     * @uses AddCompositionResource::setRequest()
     ...
     * @param \StructType\AddCompositionComponentRequest $request
     * @return \StructType\AddCompositionResource
     */
