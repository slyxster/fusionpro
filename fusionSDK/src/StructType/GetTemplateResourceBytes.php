...
/**
 * This class stands for GetTemplateResourceBytes StructType
 * @subpackage Structs
 */
class GetTemplateResourceBytes extends AbstractStructBase
{
    /**
     * The req
    ...
    public $req;
    /**
     * Constructor method for GetTemplateResourceBytes
     * @uses GetTemplateResourceBytes::setReq()
     ...
     * @param \StructType\TemplateRequest $req
     * @return \StructType\GetTemplateResourceBytes
     */
