...
/**
 * This class stands for AddWatch StructType
 * @subpackage Structs
 */
class AddWatch extends AbstractStructBase
{
    /**
     * The req
    ...
    public $req;
    /**
     * Constructor method for AddWatch
     * @uses AddWatch::setReq()
